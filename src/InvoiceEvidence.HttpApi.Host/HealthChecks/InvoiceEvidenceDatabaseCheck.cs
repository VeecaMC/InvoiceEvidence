...
public class InvoiceEvidenceDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public InvoiceEvidenceDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
